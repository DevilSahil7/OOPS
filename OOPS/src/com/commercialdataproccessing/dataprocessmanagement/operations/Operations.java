package com.commercialdataproccessing.dataprocessmanagement.operations;
...
import com.commercialdataproccessing.dataprocessmanagement.utility.Utility;
...
public class Operations {
	...
	public List<CompanyDetails> addCompany(List<CompanyDetails> compList) { // method to add new stock
		try {
	...
	public List<CustomerDetails> addCustomer(List<CustomerDetails> custList) { // method to add new customer
		try {
			// taking required data from user
	...
	public List<CustomerDetails> sellShare(List<CompanyDetails> compList, List<CustomerDetails> custList,
			List<TransactionDetails> txnList) throws JsonGenerationException, JsonMappingException, IOException { //method to sell shares of user
	...
	public List<CustomerDetails> buyShare(List<CompanyDetails> compList, List<CustomerDetails> custList,
			List<TransactionDetails> txnList) throws JsonGenerationException, JsonMappingException, IOException { //method to sell shares
	...
	public int totalSharesOfCompanies(List<CompanyDetails> compList) { //method to calculate total shares of comoanies
		int allShares = 0;
	...
	public int totalSharesOfCustomers(List<CustomerDetails> custList) { //method to calculate total shares of customers
		int allShares = 0;
